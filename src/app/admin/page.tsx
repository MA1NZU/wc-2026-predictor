  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 sm:py-8">
      <h1 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 flex items-center gap-3">
        <Shield className="w-7 h-7 sm:w-8 sm:h-8 text-wc-red" />
        Admin Panel
      </h1>
      ...
      <div className="mb-6 sm:mb-8 p-4 sm:p-6 rounded-2xl bg-white/5 border border-white/10">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <input
            ...
            className="flex-1 px-4 py-3 rounded-lg bg-white/5 border border-white/10 focus:border-wc-gold focus:outline-none text-sm"
            onKeyDown={(e) => e.key === "Enter" && createRound()}
          />
          <button
            onClick={createRound}
            disabled={creating}
            className="px-6 py-3 rounded-lg bg-wc-gold text-wc-dark font-bold hover:bg-wc-gold/90 transition disabled:opacity-50 flex items-center justify-center gap-2"
          >
          ...
          <div key={round.id} className="rounded-2xl bg-white/5 border border-white/10 overflow-hidden">
            ...
            <div className="divide-y divide-white/5">
              {round.matches.map((match) => {
                ...
                return (
                  <div key={match.id} className="px-4 sm:px-6 py-3 sm:py-4">
                    {/* Match Details */}
                    <div className="flex flex-col gap-2 sm:gap-3">
                      <div className="flex flex-col sm:flex-row gap-2">
                        ...
                        <div className="flex gap-2 items-center">
                          ...
                          <input
                            ...
                            className="flex-1 sm:flex-none px-3 py-2 rounded-lg bg-white/5 border border-white/10 focus:border-wc-gold focus:outline-none text-sm"
                          />
                          <button
                      ...
                      <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                        ...
                        <input
                          ...
                          placeholder="H"
                          className="w-16 text-center px-2 py-2 rounded-lg bg-white/5 border border-white/10 focus:border-wc-gold focus:outline-none text-sm"
                        />
